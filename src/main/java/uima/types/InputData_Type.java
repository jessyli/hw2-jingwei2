...
public class InputData_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("uima.types.InputData");
  ...
  public String getContent(int addr) {
      ...
      jcas.throwFeatMissing("content", "uima.types.InputData");
  ...
  public String getKey(int addr) {
      ...
      jcas.throwFeatMissing("key", "uima.types.InputData");
